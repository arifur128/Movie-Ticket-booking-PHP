...
$number = isset($_POST['number']) ? $_POST['number'] : 'XXXX-XXXX-XXXX-1234'; // Fallback if not posted
?>
<!doctype html>
<html>
<head>
...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
    <dt>Merchant</dt> <dd>Riverview Hall</dd>
    <dt>Transaction Amount</dt> <dd>BDT <?php echo htmlspecialchars($_SESSION['amount']); ?></dd>
    <dt>Debit Card</dt> <dd><?php echo htmlspecialchars($number); ?></dd>
  </dl>
  <hr class="divider">
      ...
      <div class="row formInputSection">
        <div class="large-7 columns">
          <label>
            ...
            <input type="password" name="otp" class="form-control optPass" value="" maxlength="6" autocomplete="off" required />
          </label>
        </div>
        <div class="large-5 columns">
          <label>&nbsp;</label>
          <button type="submit" class="expanded button next">Make Payment</button>
        </div>
      </div>
